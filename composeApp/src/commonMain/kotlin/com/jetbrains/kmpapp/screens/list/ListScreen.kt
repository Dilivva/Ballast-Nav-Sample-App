...
import com.jetbrains.kmpapp.LocalController
import com.jetbrains.kmpapp.Screen
...
fun ListScreen() {
    ...
    val screenModel: ListScreenModel = koinInject()

    LaunchedEffect(Unit){
        screenModel.getMuseums()
    }
        ...
        if (objectsAvailable) {
            ObjectGrid(
                ...
                onObjectClick = { objectId ->
                    controller.navigate(Screen.DetailScreen(objectId))
                }
            )
        } else {
